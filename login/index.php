<?php
    ...
    if(isset($_SESSION['user_id'])) {
        header('Location: /dailygrind/index.php');
    }
?>
...
<head>
    ...
    <script type="text/javascript" src="/dailygrind/login/script.js" defer></script>
    <link rel="stylesheet" href="/dailygrind/login/styles.css">
