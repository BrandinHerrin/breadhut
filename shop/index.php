<?php
    ...
    if(!isset($_SESSION['user_id'])) {
        header('Location: /dailygrind/login/index.php');
    }
...
<head>
    ...
    <script type="text/javascript" src="/dailygrind/shop/script.js" defer></script>
    ...
    <link rel="stylesheet" href="/dailygrind/shop/styles.css">
